...
public class EmployeeAssignment {
    ...
    @ManyToOne
    @JoinColumn(name = "employee_id", nullable = false)
    @JsonIgnoreProperties({"assignments", "leaveRequests", "technologies", "password"})  // ✅ Break circular reference
    private Employee employee;
    
    @ManyToOne
    @JoinColumn(name = "project_id", nullable = false)
    @JsonIgnoreProperties({"assignments", "modules"})  // ✅ Break circular reference
    private Project project;
    
    @ManyToOne
    @JoinColumn(name = "module_id", nullable = false)
    @JsonIgnoreProperties({"employee", "project"})  // ✅ Break circular reference
    private Modules modules;
    ...
    public void setModule(Modules module) { this.modules = module; }
